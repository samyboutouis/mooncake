...
questions = Question.create([{question_type:  "text", question_text: "Full name:"}, {question_type:  "text", question_text: "Email:"}, {question_type:  "text", question_text: "Graduation year:"}, {question_type:  "text", question_text: "Please enter your majors, separated by comma:"}, {question_type:  "text", question_text: "Please enter your minors, separated by comma:"}, {question_type:  "text", question_text: "Why do you want to take this course?"}, {question_type:  "text", question_text: "What is your background in this subject?"}])